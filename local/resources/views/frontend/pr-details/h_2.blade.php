...
<div class="container-fluid" id="h_2">
        ...
        <div class="row mt-3" id="pr-info">
            <div class="col-12 text-left">
                ...
                <h6>BEAUTIFULLY-MAINTAINED 2 BEDROOM APARTMENT IN BINH THANH DISTRICT</h6>

            </div>

            <div class="col-12 d-flex justify-content-between">
                <a href="" class=""><p class="text-left"><i class="fas fa-map-marker-alt pr-2"></i> Binh Thanh District, Ho Chi Minh</p></a>
