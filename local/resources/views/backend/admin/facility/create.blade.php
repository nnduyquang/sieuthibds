...
@section('container')
    ...
    @endif
    @if(isset($translation_id))
        {!! Form::open(array('route' => 'facility.storeLocale','method'=>'POST')) !!}
    @else
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12" style="text-align:  center;">
            <button id="btnDanhMuc" type="submit" class="btn btn-primary">Tạo Mới Cơ Sở Vật Chất</button>
        </div>
    </div>
    {!! Form::close() !!}
@stop